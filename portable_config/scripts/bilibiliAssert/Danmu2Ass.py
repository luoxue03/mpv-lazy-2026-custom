...
def write2file(comments, directory, stage_width, stage_height,reserve_blank=0, font_face="SimHei", font_size=16.0, text_opacity=1.0, duration_marquee=5.0, duration_still=5.0, comment_filter=None, comment_filters_file=None, is_reduce_comments=False, progress_callback=None):
    filters_regex = []
...
def main():
    ...
    parser.add_argument('-s', '--size', metavar=_('WIDTHxHEIGHT'), help=_('Stage size in pixels'), type=str, default='3840x2160')
    # 弹幕字体
    ...
    # 弹幕字体大小
    parser.add_argument('-fs', '--fontsize', metavar=_('SIZE'), help=(_('Default font size [default: %s]') % 25), type=float, default=20.0) # initial = 25.0
    # 弹幕不透明度
