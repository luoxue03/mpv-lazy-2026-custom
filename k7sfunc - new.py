...
def RIFE_NV(
	input : vs.VideoNode,
	lt_d2k : bool = False,
	model : typing.Literal[46, 422, 4221, 426, 4151, 4251] = 46,
	ext_proc : bool = True,
	t_tta : bool = False,
	fps_in : float = 23.976,
	fps_num : int = 2,
	...
	if model not in [46, 422, 4221, 426, 4151, 4251] :
		raise vs.Error(f"模块 {func_name} 的子参数 model 的值无效")
	if not isinstance(ext_proc, bool) :
		raise vs.Error(f"模块 {func_name} 的子参数 ext_proc 的值无效")
	if not isinstance(t_tta, bool) :
	...
	if model in [422, 4221] : # https://github.com/AmusementClub/vs-mlrt/blob/abc5b1c777a5dde6bad51a099f28eba99375ef4e/scripts/vsmlrt.py#L989
		t_tta = False
	if t_tta :
		mdl_fname = ["rife_v4.6_ensemble", "rife_v4.22_ensemble", "rife_v4.22_lite_ensemble", "rife_v4.15_lite_ensemble"][[46, 422, 4221, 4151].index(model)]
	else :
		mdl_fname = ["rife_v4.6", "rife_v4.22", "rife_v4.22_lite", "rife_v4.26", "rife_v4.15_lite", "rife_v4.25_lite"][[46, 422, 4221, 426, 4151, 4251].index(model)]
